                                    ...
                                    <form action="{{route('userAuth.register')}}" method="POST">
                                        ...
                                        <div class="mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" required class="form-control" name="confirm_password" id="exampleInputName1" placeholder="{{ __('user-auth::messages.register.enter_confirm_password') }}">
                                            </div>
                                        </div>
